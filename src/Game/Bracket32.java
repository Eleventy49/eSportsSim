...
public class Bracket32 {
	...
	public static void load() {
		...
		{	
			...
			{u4++;
				Application.getGame().getGraphics().drawString(winners.get(indexArray), 575, (u4 * 40)-25);
				Application.getGame().getGraphics().drawString(notWinners.get(indexArray), 575, ((u4 * 40) -30 + 20));
				if(u4 == 2)
					u4 = 0;
			}
			...
			{l7++;
				Application.getGame().getGraphics().drawString(winners.get(indexArray), 1175, ((l7 * 40) + 600)-25);
				Application.getGame().getGraphics().drawString(notWinners.get(indexArray), 1175, (((l7 * 40) + 20) -30+ 600));
				if(l7 == 1)
					l7 = 0;
			}
			if(section.get(indexArray).equals("LBR8"))
			{ l8++;
				Application.getGame().getGraphics().drawString(winners.get(indexArray), 1323, ((l8 * 40) + 600)-25);
				Application.getGame().getGraphics().drawString(notWinners.get(indexArray), 1323, (((l8 * 40) + 20)-30 + 600));
				if(l8 == 1)
					l8 = 0;
			}
