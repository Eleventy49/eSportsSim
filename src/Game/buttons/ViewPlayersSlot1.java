...
public class ViewPlayersSlot1 extends NormalButton implements ButtonInterface,MouseListener {

	public ViewPlayersSlot1()
	{
		super(new Rectangle(195, 20, 350, 50), "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewPlayer}, Application.STATE.SpectatorModeViewPlayerB, "PlayersViewPlayer");
