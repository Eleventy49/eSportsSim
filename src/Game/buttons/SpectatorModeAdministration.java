...
public class SpectatorModeAdministration extends NormalButton implements ButtonInterface,MouseListener{
	final static int Bottom = Application.HEIGHT - 41;
	public SpectatorModeAdministration()
	{
		super(new Rectangle(538, Bottom, 307, 50), "Administration", Color.red,Color.GRAY,Application.SpectatorStates,  Application.STATE.ManagerMode,"SpectatorAdministration");
