...
public class TeamsViewTeam extends NormalButton implements ButtonInterface,MouseListener{
	public TeamsViewTeam()
	{
		super(new Rectangle(800, 400, 100, 50), "View Team", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeTeams}, Application.STATE.SpectatorModeViewTeam, "TeamsViewTeam");
	}
	@Override
	public void init() {
	...
	public void mouseLeftClicked(MouseEvent e) {
		// TODO Auto-generated method stub
		System.out.println("TeamsViewTeam Clicked");
