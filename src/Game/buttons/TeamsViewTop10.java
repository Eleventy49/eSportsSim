...
public class TeamsViewTop10 extends NormalButton implements ButtonInterface,MouseListener{
	public TeamsViewTop10()
	{
		super(new Rectangle(500, 800, 100, 50), "View Top 10 Teams", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeTeams}, Application.STATE.SpectatorModeViewTop10Team, "TeamsViewTeam");
	}
	@Override
	public void init() {
