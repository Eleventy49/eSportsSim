...
public class MainMenuTutorial extends NormalButton implements ButtonInterface,MouseListener {
	...
	{
		super( new Rectangle((Application.WIDTH / 2) - 50, 700, 100, 50), "Tutorial", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.Menu}, Application.STATE.Tutorial,"MainMenuTutorial");
	}
