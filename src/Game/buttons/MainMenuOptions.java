...
public class MainMenuOptions extends NormalButton implements ButtonInterface,MouseListener{
	...
	{
		super(new Rectangle((Application.WIDTH / 2) - 50, 500, 100, 50), "Options", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.Menu}, Application.STATE.Options,"MainMenuOptions");
