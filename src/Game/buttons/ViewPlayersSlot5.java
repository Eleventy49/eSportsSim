...
public class ViewPlayersSlot5 extends NormalButton implements ButtonInterface,MouseListener{

	public ViewPlayersSlot5()
	{
		super( new Rectangle(195, 260, 350, 50), "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewPlayer}, Application.STATE.SpectatorModeViewPlayerB, "PlayersViewPlayer");
