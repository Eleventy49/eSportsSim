...
public class NotificationDismissSlot12 extends NormalButton implements ButtonInterface ,MouseListener{
	public NotificationDismissSlot12()
	{
		super( new Rectangle(125, (14 * 50) -40 , 50, 50),"", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorMode},  Application.STATE.SpectatorMode, "TeamsViewTeam");
	...
	public void draw(Graphics g, Graphics2D g2d)
	{
		...
		if( NotificationHandler.coll.size() >= 12 && Application.State == Application.STATE.SpectatorMode)
		{
...
//			g.drawString(txt, bounds.x + 5, bounds.y + 40);		
		...
		else if(this.name.equals("CornerMenuButton") || this.name.equals("CornerBackButton"))
		{
