...
public class ViewTeamsSlot5 extends NormalButton implements ButtonInterface,MouseListener{

	public ViewTeamsSlot5()
	{
		super( new Rectangle(195, 260, 350, 50),  "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTeam}, Application.STATE.SpectatorModeViewTeamB, "TeamsViewTeam");
