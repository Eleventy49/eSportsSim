...
public class PlayersTop10Mode2 extends NormalButton implements ButtonInterface,MouseListener {

	public PlayersTop10Mode2()
	{
		super(new Rectangle(100, 200, 100, 50), "Earnings Level", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTop10Player}, Application.STATE.SpectatorModeViewTop10Player, "Skill Level");
	}
