...
public class PlayersPageUp extends NormalButton implements ButtonInterface ,MouseListener{
	...
	{
		super( new Rectangle(700, 700, 50, 50), "+", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModePlayers}, Application.STATE.SpectatorModeViewPlayer, "PlayersViewPlayer");
