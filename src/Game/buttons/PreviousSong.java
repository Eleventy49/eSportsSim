...
public class PreviousSong extends SpecialButton implements ButtonInterface,MouseListener{
	...
	public PreviousSong()
	{
		super(new Rectangle(Application.WIDTH - 150, 6, 50, 50), "<|", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.Exit}, Application.STATE.Menu, "PreviousSong");
