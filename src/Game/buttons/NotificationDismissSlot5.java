...
public class NotificationDismissSlot5 extends NormalButton implements ButtonInterface ,MouseListener{
	public NotificationDismissSlot5()
	{
		super( new Rectangle(125, (7 * 50) -40 , 50, 50),"", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorMode},  Application.STATE.SpectatorMode, "TeamsViewTeam");
	...
	public void draw(Graphics g, Graphics2D g2d)
	{
		...
		if( NotificationHandler.coll.size() >= 5 && Application.State == Application.STATE.SpectatorMode)
		{
