...
public class ViewTeamPageDown extends NormalButton implements ButtonInterface,MouseListener{
	public ViewTeamPageDown()
	{
		super(new Rectangle(400, 700, 50, 50),  "-", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTeam}, Application.STATE.SpectatorModeViewTeam, "TeamsViewTeam");
	}
	@Override
	public void init() {
