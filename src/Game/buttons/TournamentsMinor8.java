...
public class TournamentsMinor8 extends NormalButton implements ButtonInterface ,MouseListener{

	public TournamentsMinor8()
	{
		super(new Rectangle((Application.WIDTH / 2) - 400, 300, 800, 50),  "Minor [8] Tournament", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.Tournaments}, Application.STATE.TournamentsMinor8Tournament, "MajorTournament");
