...
public class ViewPlayersSlot6 extends NormalButton implements ButtonInterface,MouseListener {

	public ViewPlayersSlot6()
	{
		super(new Rectangle(195, 320, 350, 50),  "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewPlayer}, Application.STATE.SpectatorModeViewPlayerB, "PlayersViewPlayer");
