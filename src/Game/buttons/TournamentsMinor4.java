...
public class TournamentsMinor4 extends NormalButton implements ButtonInterface,MouseListener {

	public TournamentsMinor4()
	{
		super(new Rectangle((Application.WIDTH / 2) - 400, 400, 800, 50),  "Minor [4] Tournament", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.Tournaments}, Application.STATE.TournamentsMinor4Tournament, "MajorTournament");
