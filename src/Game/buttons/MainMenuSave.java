...
public class MainMenuSave extends NormalButton implements ButtonInterface,MouseListener {
	public MainMenuSave()
	{
		super(new Rectangle((Application.WIDTH / 2) - 50, 400, 100, 50),  "Save Game", Color.red, Color.GRAY,new Application.STATE[]{Application.STATE.Menu}, Application.STATE.Menu, "MainMenuSaveGame");
	}
	...
	public void mouseLeftClicked(MouseEvent e) {
		...
		try {
		Filehandler.Save(Database.playerdatabase, MusicHandler.songgainControl.getValue(), MusicHandler.effectsgainControl.getValue(), Database.teamdatabase, TournamentScheduler.collection);
		}
