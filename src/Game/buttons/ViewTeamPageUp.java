...
public class ViewTeamPageUp extends NormalButton implements ButtonInterface,MouseListener{
	public ViewTeamPageUp()
	{
		super(new Rectangle(700, 700, 50, 50),"+", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTeam}, Application.STATE.SpectatorModeViewTeam, "TeamsViewTeam");
	}
	@Override
	public void init() {
	...
	public void mouseLeftClicked(MouseEvent e) {
		// TODO Auto-generated method stub
		System.out.println("Page Increased");
		Application.prevState.add(Application.State);  
		TeamViewer.increasePage();
		Music.mouseClick();
	}
