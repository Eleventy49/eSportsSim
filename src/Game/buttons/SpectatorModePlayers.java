...
public class SpectatorModePlayers extends NormalButton implements ButtonInterface,MouseListener{
	final static int Bottom = Application.HEIGHT - 41;
	public SpectatorModePlayers()
	{
		super(new Rectangle(106, Bottom, 170, 50),"Players", Color.white,Color.GRAY,Application.SpectatorStates, Application.STATE.SpectatorModePlayers,"SpectatorPlayers");
