...
public class SpectatorModeQuickFunction1 extends NormalButton implements ButtonInterface,MouseListener{
	final static int Bottom = Application.HEIGHT - 41;
	public SpectatorModeQuickFunction1()
	{
		super(new Rectangle(1097, Bottom, 327, 50), "Quick Function 1", Color.white,Color.GRAY,Application.SpectatorStates, Application.STATE.SpectatorQuickFunctionDefault,"SpectatorQuickFunction1");
