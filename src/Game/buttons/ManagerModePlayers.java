...
public class ManagerModePlayers extends NormalButton implements ButtonInterface,MouseListener{
	...
	{
		super(new Rectangle(106, Bottom, 170, 50),"Players", Color.white,Color.GRAY,new Application.STATE[]{Application.STATE.ManagerMode}, Application.STATE.SpectatorModePlayers,"SpectatorPlayers");
