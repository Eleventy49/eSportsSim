...
public class CornerBack extends SpecialButton implements ButtonInterface, MouseListener{
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(bounds.contains(x,y)) {
			System.out.println("CornerBack Clicked");
			pushed = true;
	...
	public CornerBack()
	{
		super(new Rectangle(1, 56, 100, 50), "Back", Color.white, Color.GRAY, new Application.STATE[]{Application.STATE.Menu}, Application.STATE.Menu, "CornerBackButton");
