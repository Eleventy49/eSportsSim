...
public class ManagerModeAdministration extends NormalButton implements ButtonInterface,MouseListener{
	...
	{
		super(new Rectangle(538, Bottom, 307, 50), "Administration", Color.red,Color.GRAY,new Application.STATE[]{Application.STATE.ManagerMode}, Application.STATE.ManagerMode,"SpectatorAdministration");
