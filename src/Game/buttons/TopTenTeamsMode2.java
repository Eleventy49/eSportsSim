...
public class TopTenTeamsMode2 extends NormalButton implements ButtonInterface,MouseListener{

	public TopTenTeamsMode2()
	{
		super(new Rectangle(100, 200, 100, 50), "Dynasty Level", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTop10Team}, Application.STATE.SpectatorModeViewTop10Team, "Skill Level");
	}
	@Override
	public void init() {
