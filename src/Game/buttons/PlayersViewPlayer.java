...
public class PlayersViewPlayer extends NormalButton implements ButtonInterface,MouseListener {

	public PlayersViewPlayer()
	{
		super(new Rectangle((Application.WIDTH / 2) - 50, 100, 100, 50),  "View Player", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModePlayers}, Application.STATE.SpectatorModeViewPlayer, "PlayersViewPlayer");
