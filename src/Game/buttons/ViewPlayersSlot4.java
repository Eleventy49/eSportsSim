...
public class ViewPlayersSlot4 extends NormalButton implements ButtonInterface,MouseListener{
	public ViewPlayersSlot4()
	{
		super(new Rectangle(195, 200, 350, 50), "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewPlayer}, Application.STATE.SpectatorModeViewPlayerB, "PlayersViewPlayer");
