...
public class MainMenuExit extends NormalButton implements ButtonInterface,MouseListener {
	...
	public MainMenuExit()
	{
		super( new Rectangle((Application.WIDTH / 2) - 50, 800, 100, 50), "Exit", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.Menu}, Application.STATE.Exit,"MainMenuExit");
	}
