...
public class ViewTeamsSlot10 extends NormalButton implements ButtonInterface,MouseListener{
	public ViewTeamsSlot10()
	{
		super(new Rectangle(195, 560, 350, 50), "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTeam}, Application.STATE.SpectatorModeViewTeamB, "TeamsViewTeam");
	}
	@Override
	public void init() {
