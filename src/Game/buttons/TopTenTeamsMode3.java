...
public class TopTenTeamsMode3 extends NormalButton implements ButtonInterface,MouseListener{

	public TopTenTeamsMode3()
	{
		super(new Rectangle(100, 300, 100, 50), "Earnings", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTop10Team}, Application.STATE.SpectatorModeViewTop10Team, "Skill Level");
	}
	@Override
	public void init() {
