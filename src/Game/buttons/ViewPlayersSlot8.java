...
public class ViewPlayersSlot8 extends NormalButton implements ButtonInterface,MouseListener{

	public ViewPlayersSlot8()
	{
		super(new Rectangle(195, 440, 350, 50), "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewPlayer}, Application.STATE.SpectatorModeViewPlayerB, "PlayersViewPlayer");
