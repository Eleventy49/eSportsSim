...
public class ViewPlayersSlot2 extends NormalButton implements ButtonInterface,MouseListener {

	public ViewPlayersSlot2()
	{
		super( new Rectangle(195, 80, 350, 50), "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewPlayer}, Application.STATE.SpectatorModeViewPlayerB, "PlayersViewPlayer");
