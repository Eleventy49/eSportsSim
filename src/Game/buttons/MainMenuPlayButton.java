...
public class MainMenuPlayButton extends NormalButton implements ButtonInterface,MouseListener  {
	...
	{
		super( new Rectangle(((Application.WIDTH / 2) - 50), 200, 100, 50),"New Game", Color.white, Color.gray, new Application.STATE[]{Application.STATE.Menu} ,Application.STATE.GameSelect, "New Game");
