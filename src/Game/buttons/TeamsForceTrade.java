...
public class TeamsForceTrade extends NormalButton implements ButtonInterface,MouseListener{
	public TeamsForceTrade()
	{
		super(new Rectangle(400, 300, 100, 50), "Force Trade", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeTeams}, Application.STATE.SpectatorModeTeams, "TeamsViewTeam");
	}
	@Override
	public void init() {
	...
	public void mouseLeftClicked(MouseEvent e) {
		// TODO Auto-generated method stub
		System.out.println("Trade was forced");
		Application.isInGame = true;
		Timer.forceTrade();
		Application.WarningQuery = true;
		Application.resetAlpha();
