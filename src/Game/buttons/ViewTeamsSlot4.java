...
public class ViewTeamsSlot4 extends NormalButton implements ButtonInterface,MouseListener{
	public ViewTeamsSlot4()
	{
		super( new Rectangle(195, 200, 350, 50),"", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTeam}, Application.STATE.SpectatorModeViewTeamB, "TeamsViewTeam");
