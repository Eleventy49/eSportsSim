...
import Game.TeamTenTeams;
import Game.Application.STATE;

public class TopTenTeamsMode4 extends NormalButton implements ButtonInterface,MouseListener{

	public TopTenTeamsMode4()
	{
		super(new Rectangle(100, 400, 100, 50), "Tournament Wins", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTop10Team}, Application.STATE.SpectatorModeViewTop10Team, "Skill Level");
	}
	@Override
	public void init() {
