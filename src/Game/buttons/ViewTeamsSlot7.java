...
public class ViewTeamsSlot7 extends NormalButton implements ButtonInterface,MouseListener {
	public ViewTeamsSlot7()
	{
		super(new Rectangle(195, 380, 350, 50), "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTeam}, Application.STATE.SpectatorModeViewTeamB, "TeamsViewTeam");
	}
	@Override
	public void init() {
