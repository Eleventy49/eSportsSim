...
public class PlayersTop10Mode1 extends NormalButton implements ButtonInterface ,MouseListener{

	public PlayersTop10Mode1()
	{
		super(new Rectangle(100, 100, 100, 50), "Skill Level", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTop10Player}, Application.STATE.SpectatorModeViewTop10Player, "Skill Level");
	}
	@Override
	public void init() {
