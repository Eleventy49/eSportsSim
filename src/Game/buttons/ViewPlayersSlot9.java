...
public class ViewPlayersSlot9 extends NormalButton implements ButtonInterface, MouseListener {
	public ViewPlayersSlot9()
	{
		super(new Rectangle(195, 500, 350, 50), "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewPlayer}, Application.STATE.SpectatorModeViewPlayerB, "PlayersViewPlayer");
