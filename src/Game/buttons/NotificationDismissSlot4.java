...
public class NotificationDismissSlot4 extends NormalButton implements ButtonInterface,MouseListener {
	public NotificationDismissSlot4()
	{
		super( new Rectangle(125, (6 * 50) -40 , 50, 50),"", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorMode},  Application.STATE.SpectatorMode, "TeamsViewTeam");
	...
	public void draw(Graphics g, Graphics2D g2d)
	{
		...
		if(NotificationHandler.coll.size() >= 4 && Application.State == Application.STATE.SpectatorMode)
		{
