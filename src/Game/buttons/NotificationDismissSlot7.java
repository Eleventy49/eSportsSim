...
public class NotificationDismissSlot7 extends NormalButton implements ButtonInterface,MouseListener {
	public NotificationDismissSlot7()
	{
		super( new Rectangle(125, (9 * 50) -40 , 50, 50),"", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorMode},  Application.STATE.SpectatorMode, "TeamsViewTeam");
	...
	public void draw(Graphics g, Graphics2D g2d)
	{
		...
		if(NotificationHandler.coll.size() >=7  && Application.State == Application.STATE.SpectatorMode)
		{
