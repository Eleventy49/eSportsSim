...
public class TeamsAddTeam extends NormalButton implements ButtonInterface,MouseListener {

	public TeamsAddTeam()
	{
		super( new Rectangle((Application.WIDTH / 2) - 50, 200, 100, 50) , "Add Team", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeTeams}, Application.STATE.SpectatorModeAddTeam, "TeamAddTeam");
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(bounds.contains(x,y) && Application.gameStateIsPartOf(Application.State, prereq)) {
			System.out.println("We really shouldn't have got here, but hey");
		if(e.getButton() == MouseEvent.BUTTON1)
		{
			System.out.println("Time to add a team");
			mouseLeftClicked(e);
		}
