...
public class ViewTeamsSlot8 extends NormalButton implements ButtonInterface,MouseListener{
	public ViewTeamsSlot8()
	{
		super(new Rectangle(195, 440, 350, 50),"", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTeam}, Application.STATE.SpectatorModeViewTeamB, "TeamsViewTeam");
	}
	@Override
	public void init() {
