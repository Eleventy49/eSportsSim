...
public class MainMenuLoad extends NormalButton implements ButtonInterface ,MouseListener{
	public MainMenuLoad()
	{
		super(new Rectangle((Application.WIDTH / 2) - 50, 300, 100, 50),  "Load Game", Color.red, Color.GRAY,new Application.STATE[]{Application.STATE.Menu}, Application.STATE.LoadGame, "MainMenuLoadGame");
	}
	@Override
	public void init() {
