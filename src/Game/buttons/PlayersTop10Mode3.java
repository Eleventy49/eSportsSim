...
import Game.TeamTenPlayers;
import Game.Application.STATE;

public class PlayersTop10Mode3 extends NormalButton implements ButtonInterface,MouseListener {

	public PlayersTop10Mode3()
	{
		super(new Rectangle(100, 300, 100, 50), "Tournament Wins", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTop10Player}, Application.STATE.SpectatorModeViewTop10Player, "Skill Level");
	}
