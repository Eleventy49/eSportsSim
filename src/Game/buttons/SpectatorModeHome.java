...
public class SpectatorModeHome extends NormalButton implements ButtonInterface,MouseListener {
	final static int Bottom = Application.HEIGHT - 41;
	public SpectatorModeHome()
	{
		super(new Rectangle(0, Bottom, 105, 50), "Home", Color.white,Color.GRAY,Application.SpectatorStates, Application.STATE.SpectatorMode,"SpectatorHome");
