...
public class ViewPlayersSlot3 extends NormalButton implements ButtonInterface,MouseListener {
	
	public ViewPlayersSlot3()
	{
		super(new Rectangle(195, 140, 350, 50), "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewPlayer}, Application.STATE.SpectatorModeViewPlayerB, "PlayersViewPlayer");
