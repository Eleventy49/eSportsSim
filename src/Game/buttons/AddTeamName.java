...
public class AddTeamName extends NormalButton implements ButtonInterface, MouseListener {
	...
	public AddTeamName()
	{
		super(new Rectangle(200, 300, 500, 50), "", Color.white, Color.GRAY, new Application.STATE[]{Application.STATE.SpectatorModeAddTeam}, Application.STATE.SpectatorModeAddTeam, "AddTeamName");
