...
public class PlayersTop10 extends NormalButton implements ButtonInterface,MouseListener {

	public PlayersTop10() {
		
		super( new Rectangle((Application.WIDTH / 2) - 50, 300, 100, 50), "View Top 10 Players", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModePlayers}, Application.STATE.SpectatorModeViewTop10Player, "PlayersViewPlayer");
