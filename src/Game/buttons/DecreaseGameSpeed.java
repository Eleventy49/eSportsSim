...
public class DecreaseGameSpeed extends SpecialButton implements ButtonInterface,MouseListener{
	...
	{
		super(new Rectangle(100, 6, 50, 50), "<<", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.Menu,Application.STATE.Menu}, Application.STATE.Menu, "DEFAULT");
