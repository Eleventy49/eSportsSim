...
public class NotificationDismissSlot14 extends NormalButton implements ButtonInterface,MouseListener {
	public NotificationDismissSlot14()
	{
		super( new Rectangle(125, (16 * 50) -40 , 50, 50),"", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorMode},  Application.STATE.SpectatorMode, "TeamsViewTeam");
	...
	public void draw(Graphics g, Graphics2D g2d)
	{
		...
		if( NotificationHandler.coll.size() >= 14 && Application.State == Application.STATE.SpectatorMode)
		{
