...
public class PlayPause extends SpecialButton implements ButtonInterface,MouseListener{
	...
	public PlayPause()
	{
		super(new Rectangle(Application.WIDTH - 100, 6, 50, 50), "||", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.Exit}, Application.STATE.Menu, "DEFAULT");
	...
	public void mouseLeftClicked(MouseEvent e) {
		// TODO Auto-generated method stub
		System.out.println("MusicPlayPause");
		Music.playpause();
		Music.mouseClick();
