...
public class NotificationDismissSlot10 extends NormalButton implements ButtonInterface ,MouseListener{
	...
	{
		super( new Rectangle(125, (12 * 50) -40 , 50, 50),"", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorMode}, Application.STATE.SpectatorMode, "TeamsViewTeam");
