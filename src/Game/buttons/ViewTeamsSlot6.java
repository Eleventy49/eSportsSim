...
public class ViewTeamsSlot6 extends NormalButton implements ButtonInterface,MouseListener{
	public ViewTeamsSlot6()
	{
		super(new Rectangle(195, 320, 350, 50),  "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTeam}, Application.STATE.SpectatorModeViewTeamB, "TeamsViewTeam");
	}
	@Override
	public void init() {
