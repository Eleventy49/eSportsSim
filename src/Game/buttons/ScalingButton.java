...
public class ScalingButton implements MouseListener, MouseMotionListener {
	...
	public ScalingButton(Rectangle b, String t, Color co, Color co2, Application.STATE[] states, Application.STATE gs,
			String n) {
		bounds = b;
		txt = t;
		cDefault = co;
	...
	public ScalingButton(Rectangle b, String t, Color co, Color co2, ArrayList<Application.STATE> states,
