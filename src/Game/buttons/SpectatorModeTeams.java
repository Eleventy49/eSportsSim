...
public class SpectatorModeTeams extends NormalButton implements ButtonInterface,MouseListener{
	final static int Bottom = Application.HEIGHT - 41;
	public SpectatorModeTeams()
	{
		super(new Rectangle(846, Bottom, 250, 50), "Teams", Color.white,Color.GRAY,Application.SpectatorStates, Application.STATE.SpectatorModeTeams,"SpectatorScoutTeams");
