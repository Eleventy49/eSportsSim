...
public class ViewPlayersSlot7 extends NormalButton implements ButtonInterface , MouseListener{
	
	public ViewPlayersSlot7()
	{
		super(new Rectangle(195, 380, 350, 50), "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewPlayer}, Application.STATE.SpectatorModeViewPlayerB, "PlayersViewPlayer");
