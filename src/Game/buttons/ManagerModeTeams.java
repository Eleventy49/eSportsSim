...
public class ManagerModeTeams extends NormalButton implements ButtonInterface,MouseListener{
	...
	{
		super(new Rectangle(846, Bottom, 250, 50), "Teams", Color.white,Color.GRAY,new Application.STATE[]{Application.STATE.ManagerMode}, Application.STATE.SpectatorModeTeams,"SpectatorScoutTeams");
