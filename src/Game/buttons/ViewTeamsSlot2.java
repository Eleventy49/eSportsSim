...
public class ViewTeamsSlot2 extends NormalButton implements ButtonInterface,MouseListener{
	public ViewTeamsSlot2()
	{
		super(new Rectangle(195, 80, 350, 50), "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTeam}, Application.STATE.SpectatorModeViewTeamB, "TeamsViewTeam");
