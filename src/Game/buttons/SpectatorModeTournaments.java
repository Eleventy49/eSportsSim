...
public class SpectatorModeTournaments extends NormalButton implements ButtonInterface,MouseListener{
	final static int Bottom = Application.HEIGHT - 41;
	public SpectatorModeTournaments()
	{
		super(new Rectangle(277, Bottom, 260, 50), "Tournaments", Color.white,Color.GRAY, 
				Application.SpectatorStates,Application.STATE.Tournaments,"SpectatorTournaments");
