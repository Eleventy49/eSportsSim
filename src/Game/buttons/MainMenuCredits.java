...
public class MainMenuCredits extends NormalButton implements ButtonInterface ,MouseListener{
	...
	{
		super(new Rectangle((Application.WIDTH / 2) - 50, 600, 100, 50), "Credits", Color.red, Color.GRAY,new Application.STATE[]{Application.STATE.Menu}, Application.STATE.Credits,"MainMenuCredits");
