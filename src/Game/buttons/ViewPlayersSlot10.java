...
public class ViewPlayersSlot10 extends NormalButton implements ButtonInterface,MouseListener{
	public ViewPlayersSlot10()
	{
		super( new Rectangle(195, 560, 350, 50), "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewPlayer}, Application.STATE.SpectatorModeViewPlayerB, "PlayersViewPlayer");
