...
public class AddTeamAbb extends NormalButton implements ButtonInterface, MouseListener {
	...
	public AddTeamAbb()
	{
		super(new Rectangle(200, 400, 500, 50), "", Color.white, Color.GRAY, new Application.STATE[]{Application.STATE.SpectatorModeAddTeam},Application.STATE.SpectatorModeAddTeam, "AddTeamAbb");
