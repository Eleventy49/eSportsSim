...
public class TournamentsMajor extends NormalButton implements ButtonInterface,MouseListener {

	public TournamentsMajor()
	{
		super(new Rectangle((Application.WIDTH / 2) - 400, 200, 800, 50),  "Major Tournament", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.Tournaments}, Application.STATE.TournamentsMajorTournament, "MajorTournament");
