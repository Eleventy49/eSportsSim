...
public class TournamentsWorld extends NormalButton implements ButtonInterface,MouseListener {

	public TournamentsWorld()
	{
		super(new Rectangle((Application.WIDTH / 2) - 400, 100, 800, 50),  "World Tournament", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.Tournaments}, Application.STATE.TournamentsWorldTournament, "WorldTournament");
