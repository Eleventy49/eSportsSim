...
public class TopTenTeamsMode5 extends NormalButton implements ButtonInterface,MouseListener{

	public TopTenTeamsMode5()
	{
		super(new Rectangle(100, 500, 100, 50), "Recent Wins", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTop10Team}, Application.STATE.SpectatorModeViewTop10Team, "Skill Level");
	}
	@Override
	public void init() {
