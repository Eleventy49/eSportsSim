...
public class ViewTeamsSlot3 extends NormalButton implements ButtonInterface,MouseListener{

	public ViewTeamsSlot3()
	{
		super( new Rectangle(195, 140, 350, 50), "", Color.white, Color.GRAY,new Application.STATE[]{Application.STATE.SpectatorModeViewTeam}, Application.STATE.SpectatorModeViewTeamB, "TeamsViewTeam");
